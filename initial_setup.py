...
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (2, 'Children_BAD', 1, " + UnixEpoch + "," + UnixEpoch + ", 'Very restrictive')")
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (3, 'Children_Good', 1, " + UnixEpoch + "," + UnixEpoch + ", 'Blocks malware,ads and porn')")
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (4, 'Children_Education', 1, " + UnixEpoch + "," + UnixEpoch + ", 'For Remote Learning, Allows: Youtube / Google Classroom, Zoom')")
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (5, 'Children_Fun', 1, " + UnixEpoch + "," + UnixEpoch + ", 'Games, Chat, Streaming Video & Audio')")
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (6, 'Children_Bed', 1, " + UnixEpoch + "," + UnixEpoch + ", 'Blocks almost everything, so they go to sleep')")
cur.execute("INSERT INTO 'group' (id, name, enabled, date_added, date_modified, description) VALUES (7, 'Adults', 1, " + UnixEpoch + "," + UnixEpoch + ", 'Allows porn, blocks everything else')")
...
#--- Son ---
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (2, 1)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (4, 1)")

cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (2, 4)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (2, 2)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (3, 2)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (4, 4)")

#--- Daugther ---
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (5, 1)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (6, 1)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (7, 1)")

cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (5, 3)")
cur.execute("INSERT INTO client_by_group (client_id, group_id) VALUES (6, 3)")
